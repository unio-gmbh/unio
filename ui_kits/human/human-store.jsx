...
const HM_SEED_FLAG = "unio_hm_seed_v3";
...
const HM_SEED_ANTWORTEN = {
  markus: { seit: "5 bis 10 Jahre", herkunft: "Aus Finanz oder Recht", abschluesse: "Zinshäuser und Investment", gruende: ["Preis-Einschätzung war realistisch", "Diskretion", "Kennt den Bezirk"], hindernis: ["Provision"], ausloeser: ["Erbe", "Investment"], milieus: ["kons", "perf"], phasen: ["Investoren", "Erben"], bezirke: ["1190 Döbling", "1180 Währing", "1130 Hietzing"], seite: 25, gefuehl: ["Sicher", "Gut beraten"], s1: 20, s2: 30, s3: 35, s4: 50, s5: 70, archetyp: ["kenner"], worte: "genau, ruhig, verlässlich", tabus: ["Politik", "Familie zeigen"], anrede: "Sie", bestand: ["Logo", "Website", "LinkedIn", "Instagram"], follower: "500 bis 2.000", behalten: "Behalten und schärfen", assets: ["Eine Farbe", "Ein Satz"], vorbilder: "@wienerimmobilien, weil sachlich", kamera: 3, zeit: "2 bis 4 Stunden", formate: ["talking", "carousel", "qa"], kanaele: ["linkedin", "instagram", "facebook", "youtube", "tiktok"], ziel: "Investoren erreichen", verfuegbar: ["Dienstag", "Donnerstag", "Vormittag"] },
  elif: { seit: "2 bis 5 Jahre", herkunft: "Quereinstieg aus dem Verkauf", abschluesse: "Eigentumswohnungen Neubau", gruende: ["Sympathie", "Schnelle Rückmeldung", "Kennt den Bezirk"], hindernis: ["Zweifel am Preis"], ausloeser: ["Familie wächst", "Umzug aus beruflichen Gründen"], milieus: ["mitte", "neo"], phasen: ["Erste Wohnung", "Familiengründung"], bezirke: ["1100 Favoriten", "1120 Meidling", "1230 Liesing"], seite: 65, gefuehl: ["Zuhause", "Entlastet"], s1: 55, s2: 85, s3: 70, s4: 65, s5: 40, archetyp: ["gastgeber"], worte: "herzlich, schnell, ehrlich", tabus: ["Luxus zeigen"], anrede: "Du", bestand: ["Instagram", "TikTok", "Professionelle Fotos"], follower: "2.000 bis 10.000", behalten: "Neu aufsetzen", assets: ["Ein Ort", "Eine Geste"], vorbilder: "@grätzlgeschichten, weil nah", kamera: 5, zeit: "4 bis 8 Stunden", formate: ["talking", "spaziergang", "behind", "walkthrough"], kanaele: ["instagram", "tiktok", "facebook", "linkedin", "youtube"], ziel: "Bekannt im Bezirk werden", verfuegbar: ["Montag", "Mittwoch", "Nachmittag"] },
};
